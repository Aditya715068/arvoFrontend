...
function Products_details({propertyDetails}) {
  ...
  return (
    <article className="w-full md:w-full mt-6 lg:mt-0 lg:w-[445px] text-sm font-bold px-4 lg:p-0">
      ...
      <p className="max-w-[900px] break-words text-sm sm:text-base  font-light leading-19 mt-4 lg:mt-9 tracking-[4%] sm:tracking-normal text-grayish-blue" role={"contentinfo"} >
   {propertyDetails.description}
</p>
 <div className="border-t border-gray-300 my-4"></div>

      <p className="max-w-[600px] break-words text-sm sm:text-base  font-light leading-10 mt-4 lg:mt-9 tracking-[4%] sm:tracking-normal text-grayish-blue" role={"contentinfo"}>
   {propertyDetails.brandDetail}
</p>
